...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Firewall Bruteforce Success** | T1110.004, TA0001 | [firewall-bruteforce-investigation.spl](/Investigations/firewall-bruteforce-investigation.spl) | Detects multiple failed connections followed by a success to SSH/RDP ports. Indicates likely credential compromise. | High | Low | 1. Correlate with Windows/Linux auth logs for the target IP. 2. Check if source IP is in threat intel feed. |
