...
| **Windows RDP Bruteforce** | T1110.001 | [windows-brute-force-detection.spl](/Investigations/windows-analysis/spl-queries/windows-brute-force-detection.spl) | Identifies 5+ failed logins (EventID 4625) for a single account within 10 minutes. | Medium | Medium | Common for service accounts. Verify if account has lockout policy enabled. |
